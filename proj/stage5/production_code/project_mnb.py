...
np.savez('mnb_testing', fooz = train_vec, ball = test_vec)
#np.save('mnb_train_vec.npy', train_vec)
#np.save('mnb_test_vec.npy', test_vec)
train_in.keys()
#%%
#
train_in = np.load('mnb_testing.npz', allow_pickle=True)
bar = train_in['fooz']
